...
const singleStoryComponentIds=React$2.useMemo(()=>{return orphansFirst.filter(nodeId=>{const{children=[],isComponent,isLeaf,name}=data[nodeId];return!isLeaf&&isComponent&&children.length===1&&api.isStory(data[children[0]])&&data[children[0]].name===name;});},[data,orphansFirst]);// Omit single-story components from the list of nodes.

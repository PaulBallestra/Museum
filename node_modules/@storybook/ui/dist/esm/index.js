 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var printWarning$1=function printWarning$1(){};if(process.env.NODE_ENV!=='production'){var ReactPropTypesSecret$2=ReactPropTypesSecret_1;var loggedTypeFailures={};var has$6=has$7;printWarning$1=function printWarning$1(text){var message='Warning: '+text;if(typeof console!=='undefined'){console.error(message);}try{// --- Welcome to debugging React ---
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ReactIs$1=reactIs$1.exports;var assign$1=objectAssign;var ReactPropTypesSecret$1=ReactPropTypesSecret_1;var has$5=has$7;var checkPropTypes=checkPropTypes_1;var printWarning=function printWarning(){};if(process.env.NODE_ENV!=='production'){printWarning=function printWarning(text){var message='Warning: '+text;if(typeof console!=='undefined'){console.error(message);}try{// --- Welcome to debugging React ---
// This error was thrown as a convenience so that you can use this stack
// to find the callsite that caused this warning to fire.
...
return x!==x&&y!==y;}}/*eslint-enable no-self-compare*/ /**
   ...
   */function PropTypeError(message,data){this.message=message;this.data=data&&_typeof2(data)==='object'?data:{};this.stack='';}// Make `instanceof Error` still work for returned errors.
...
function getPropType(propValue){var propType=_typeof2(propValue);if(Array.isArray(propValue)){return'array';}if(propValue instanceof RegExp){// Old webkits (at least until Android 4.0) return 'function' rather than
...
if(a===b)return true;if(a&&b&&_typeof2(a)=='object'&&_typeof2(b)=='object'){if(a.constructor!==b.constructor)return false;var length,i,keys;if(Array.isArray(a)){length=a.length;if(length!=b.length)return false;for(i=length;i--!==0;){if(!equal(a[i],b[i]))return false;}return true;}// START: Modifications:
 ...
 */var NODE_ENV=process.env.NODE_ENV;var invariant$1=function invariant$1(condition,format,a,b,c,d,e,f){if(NODE_ENV!=='production'){if(format===undefined){throw new Error('invariant requires an error message argument');}}if(!condition){var error;if(format===undefined){error=new Error('Minified exception occurred; use the non-minified dev environment '+'for the full error message and additional helpful warnings.');}else{var args=[a,b,c,d,e,f];var argIndex=0;error=new Error(format.replace(/%s/g,function(){return args[argIndex++];}));error.name='Invariant Violation';}error.framesToPop=1;// we don't care about invariant's own frame
throw error;}};var invariant_1=invariant$1;var shallowequal=function shallowEqual(objA,objB,compare,compareContext){var ret=compare?compare.call(compareContext,objA,objB):void 0;if(ret!==void 0){return!!ret;}if(objA===objB){return true;}if(_typeof2(objA)!=="object"||!objA||_typeof2(objB)!=="object"||!objB){return false;}var keysA=Object.keys(objA);var keysB=Object.keys(objB);if(keysA.length!==keysB.length){return false;}var bHasOwnProperty=Object.prototype.hasOwnProperty.bind(objB);// Test for A's keys different from B.
 ...
 */utils$6.forEach=function(collection,callback){for(var i=0;i<collection.length;i++){var result=callback(collection[i]);if(result){return result;}}};var elementUtils=function elementUtils(options){var getState=options.stateHandler.getState;/**
   ...
   */function markBusy(element,busy){getState(element).busy=!!busy;}return{isDetectable:isDetectable,markAsDetectable:markAsDetectable,isBusy:isBusy,markBusy:markBusy};};var listenerHandler=function listenerHandler(idHandler){var eventListeners={};/**
   ...
   */function generate(){return idCount++;}return{generate:generate};};var idHandler=function idHandler(options){var idGenerator=options.idGenerator;var getState=options.stateHandler.getState;/**
 ...
 */var reporter=function reporter(quiet){function noop(){//Does nothing.
}var reporter={log:noop,warn:noop,error:noop};if(!quiet&&window.console){var attachFunction=function attachFunction(reporter,name){//The proxy is needed to be able to call the method with the console context,
 ...
 */var elementResizeDetector=function elementResizeDetector(options){options=options||{};//idHandler is currently not an option to the listenTo function, so it should not be added to globalOptions.
...
idHandler={get:function get(element){return options.idHandler.get(element,true);},set:options.idHandler.set};}else{var idGenerator=idGeneratorMaker();var defaultIdHandler=idHandlerMaker({idGenerator:idGenerator,stateHandler:stateHandler});idHandler=defaultIdHandler;}//reporter is currently not an option to the listenTo function, so it should not be added to globalOptions.
...
inherit:function inherit(api,o){for(var p in api){if(!o.hasOwnProperty(p)){Object.defineProperty(o,p,Object.getOwnPropertyDescriptor(api,p));}}return o;},stringify:function stringify(d,fn){return d===undefined||typeof d==="function"?d+'':JSON.stringify(d,fn||_.replace);},parse:function parse(s,fn){// if it doesn't parse, return as is
try{return JSON.parse(s,fn||_.revive);}catch(e){return s;}},// extension hooks
fn:function fn(name,_fn){_.storeAPI[name]=_fn;for(var api in _.apis){_.apis[api][name]=_fn;}},get:function get(area,key){return area.getItem(key);},set:function set(area,key,string){area.setItem(key,string);},remove:function remove(area,key){area.removeItem(key);},key:function key(area,i){return area.key(i);},length:function length(area){return area.length;},clear:function clear(area){area.clear();},// core functions
Store:function Store(id,area,namespace){var store=_.inherit(_.storeAPI,function(key,data,overwrite){if(arguments.length===0){return store.getAll();}if(typeof data==="function"){return store.transact(key,data,overwrite);}// fn=data, alt=overwrite
...
area:function area(id,_area){var store=this[id];if(!store||!store.area){store=_.Store(id,_area,this._ns);//new area-specific api in this namespace
if(!this[id]){this[id]=store;}}return store;},namespace:function namespace(_namespace,singleArea){if(!_namespace){return this._ns?this._ns.substring(0,this._ns.length-1):'';}var ns=_namespace,store=this[ns];if(!store||!store.namespace){store=_.Store(this._id,this._area,this._ns+ns+'.');//new namespaced api
...
has:function has(key){if(this._area.has){return this._area.has(this._in(key));//extension hook
}return!!(this._in(key)in this._area);},size:function size(){return this.keys().length;},each:function each(fn,fill){// fill is used by keys(fillList) and getAll(fillList))
...
if(window.store){_.conflict=window.store;}window.store=store;}})(commonjsGlobal,commonjsGlobal&&commonjsGlobal.define);})(store2);var store$4=store2.exports;/**
 ...
 * _.isObjectLike(null);
 * // => false
 */function isObjectLike$1(value){return value!=null&&_typeof2(value)=='object';}var isObjectLike_1=isObjectLike$1;var baseGetTag=_baseGetTag,isObjectLike=isObjectLike_1;/** `Object#toString` result references. */var symbolTag='[object Symbol]';/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function isSymbol$5(value){return _typeof2(value)=='symbol'||isObjectLike(value)&&baseGetTag(value)==symbolTag;}var isSymbol_1=isSymbol$5;var baseTrim=_baseTrim,isObject$9=isObject_1,isSymbol$4=isSymbol_1;/** Used as references for various `Number` constants. */var NAN=0/0;/** Used to detect bad signed hexadecimal string values. */var reIsBadHex=/^[-+]0x[0-9a-f]+$/i;/** Used to detect binary string values. */var reIsBinary=/^0b[01]+$/i;/** Used to detect octal string values. */var reIsOctal=/^0o[0-7]+$/i;/** Built-in method references without a dependency on `root`. */var freeParseInt=parseInt;/**
...
function isEqual(val1,val2){return val1===val2||val1!==val1&&val2!==val2;}var get$2=function get$2(){try{var _data=store$4.local.get("storybook-layout");return _data||false;}catch(e){// eslint-disable-next-line no-console
console.error(e);return false;}};var write=memoizerific(1)(function(changes){try{store$4.local.set("storybook-layout",changes);}catch(e){// eslint-disable-next-line no-console
console.error(e);}});var set$1=debounce_1(write,500);var cjs={exports:{}};var Draggable$2={};function toVal(mix){var k,y,str='';if(typeof mix==='string'||typeof mix==='number'){str+=mix;}else if(_typeof2(mix)==='object'){if(Array.isArray(mix)){for(k=0;k<mix.length;k++){if(mix[k]){if(y=toVal(mix[k])){str&&(str+=' ');str+=y;}}}}else{for(k in mix){if(mix[k]){str&&(str+=' ');str+=k;}}}}return str;}function clsx_m(){var i=0,tmp,x,str='';while(i<arguments.length){if(tmp=arguments[i++]){if(x=toVal(tmp)){str&&(str+=' ');str+=x;}}}return str;}var clsx_m$1=/*#__PURE__*/Object.freeze({__proto__:null,'default':clsx_m});var require$$3=/*@__PURE__*/getAugmentedNamespace(clsx_m$1);var domFns={};var shims={};Object.defineProperty(shims,"__esModule",{value:true});shims.findInArray=findInArray;shims.isFunction=isFunction;shims.isNum=isNum;shims.int=int;shims.dontSetMe=dontSetMe;// @credits https://gist.github.com/rogozhnikoff/a43cfed27c41e4e68cdc
...
mutation.resizerNav={x:minNavX,y:0};}}if(isPanelRight&&!isPanelHidden){var maxPanelX=bounds.width-MIN_PANEL_WIDTH;var minPanelX=navX+MIN_CANVAS_WIDTH;if(panelX>maxPanelX||panelX===0){// upper bound or when switching orientation
mutation.resizerPanel={x:maxPanelX,y:0};}else if(panelX<minPanelX){// lower bound
mutation.resizerPanel={x:minPanelX,y:0};}}if(isPanelBottom&&!isPanelHidden){var maxPanelY=bounds.height-MIN_PANEL_HEIGHT;if(panelY>maxPanelY||panelY===0){// lower bound or when switching orientation
 ...
 *   background: "#ffcd64";
 * }
 */function rgb(value,green,blue){if(typeof value==='number'&&typeof green==='number'&&typeof blue==='number'){return reduceHexValue$1("#"+numberToHex(value)+numberToHex(green)+numberToHex(blue));}else if(_typeof2(value)==='object'&&green===undefined&&blue===undefined){return reduceHexValue$1("#"+numberToHex(value.red)+numberToHex(value.green)+numberToHex(value.blue));}throw new PolishedError(6);}/**
...
function(){return this;}()||Function('return this')();var objectGetOwnPropertyDescriptor={};var fails$e=function fails$e(exec){try{return!!exec();}catch(error){return true;}};var fails$d=fails$e;// Detect IE8's incomplete defineProperty implementation
var descriptors=!fails$d(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
return Object.defineProperty({},1,{get:function get(){return 7;}})[1]!=7;});var fails$c=fails$e;var functionBindNative=!fails$c(function(){var test=function(){/* empty */}.bind();// eslint-disable-next-line no-prototype-builtins -- safe
...
var requireObjectCoercible$4=function requireObjectCoercible$4(it){if(it==undefined)throw TypeError$8("Can't call method on "+it);return it;};var IndexedObject$2=indexedObject;var requireObjectCoercible$3=requireObjectCoercible$4;var toIndexedObject$5=function toIndexedObject$5(it){return IndexedObject$2(requireObjectCoercible$3(it));};// https://tc39.es/ecma262/#sec-iscallable
var isCallable$c=function isCallable$c(argument){return typeof argument=='function';};var isCallable$b=isCallable$c;var isObject$6=function isObject$6(it){return _typeof2(it)=='object'?it!==null:isCallable$b(it);};var global$p=global$s;var isCallable$a=isCallable$c;var aFunction=function aFunction(argument){return isCallable$a(argument)?argument:undefined;};var getBuiltIn$5=function getBuiltIn$5(namespace,method){return arguments.length<2?aFunction(global$p[namespace]):global$p[namespace]&&global$p[namespace][method];};var uncurryThis$d=functionUncurryThis;var objectIsPrototypeOf=uncurryThis$d({}.isPrototypeOf);var getBuiltIn$4=getBuiltIn$5;var engineUserAgent=getBuiltIn$4('navigator','userAgent')||'';var global$o=global$s;var userAgent=engineUserAgent;var process$1=global$o.process;var Deno=global$o.Deno;var versions=process$1&&process$1.versions||Deno&&Deno.version;var v8=versions&&versions.v8;var match,version;if(v8){match=v8.split('.');// in old Chrome, versions of V8 isn't V8 = Chrome / 10
...
!Symbol.sham&&V8_VERSION$1&&V8_VERSION$1<41;});/* eslint-disable es/no-symbol -- required for testing */var NATIVE_SYMBOL$1=nativeSymbol;var useSymbolAsUid=NATIVE_SYMBOL$1&&!Symbol.sham&&_typeof2(Symbol.iterator)=='symbol';var global$n=global$s;var getBuiltIn$3=getBuiltIn$5;var isCallable$9=isCallable$c;var isPrototypeOf=objectIsPrototypeOf;var USE_SYMBOL_AS_UID$1=useSymbolAsUid;var Object$3=global$n.Object;var isSymbol$3=USE_SYMBOL_AS_UID$1?function(it){return _typeof2(it)=='symbol';}:function(it){var $Symbol=getBuiltIn$3('Symbol');return isCallable$9($Symbol)&&isPrototypeOf($Symbol.prototype,Object$3(it));};var global$m=global$s;var String$3=global$m.String;var tryToString$1=function tryToString$1(argument){try{return String$3(argument);}catch(error){return'Object';}};var global$l=global$s;var isCallable$8=isCallable$c;var tryToString=tryToString$1;var TypeError$7=global$l.TypeError;// `Assert: IsCallable(argument) is true`
var aCallable$2=function aCallable$2(argument){if(isCallable$8(argument))return argument;throw TypeError$7(tryToString(argument)+' is not a function');};var aCallable$1=aCallable$2;// `GetMethod` abstract operation
// https://tc39.es/ecma262/#sec-getmethod
var getMethod$2=function getMethod$2(V,P){var func=V[P];return func==null?undefined:aCallable$1(func);};var global$k=global$s;var call$5=functionCall;var isCallable$7=isCallable$c;var isObject$5=isObject$6;var TypeError$6=global$k.TypeError;// `OrdinaryToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-ordinarytoprimitive
var ordinaryToPrimitive$1=function ordinaryToPrimitive$1(input,pref){var fn,val;if(pref==='string'&&isCallable$7(fn=input.toString)&&!isObject$5(val=call$5(fn,input)))return val;if(isCallable$7(fn=input.valueOf)&&!isObject$5(val=call$5(fn,input)))return val;if(pref!=='string'&&isCallable$7(fn=input.toString)&&!isObject$5(val=call$5(fn,input)))return val;throw TypeError$6("Can't convert object to primitive value");};var shared$4={exports:{}};var global$j=global$s;// eslint-disable-next-line es/no-object-defineproperty -- safe
var defineProperty=Object.defineProperty;var setGlobal$3=function setGlobal$3(key,value){try{defineProperty(global$j,key,{value:value,configurable:true,writable:true});}catch(error){global$j[key]=value;}return value;};var global$i=global$s;var setGlobal$2=setGlobal$3;var SHARED='__core-js_shared__';var store$3=global$i[SHARED]||setGlobal$2(SHARED,{});var sharedStore=store$3;var store$2=sharedStore;(shared$4.exports=function(key,value){return store$2[key]||(store$2[key]=value!==undefined?value:{});})('versions',[]).push({version:'3.21.1',mode:'global',copyright:'© 2014-2022 Denis Pushkarev (zloirock.ru)',license:'https://github.com/zloirock/core-js/blob/v3.21.1/LICENSE',source:'https://github.com/zloirock/core-js'});var global$h=global$s;var requireObjectCoercible$2=requireObjectCoercible$4;var Object$2=global$h.Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
var toObject$2=function toObject$2(argument){return Object$2(requireObjectCoercible$2(argument));};var uncurryThis$c=functionUncurryThis;var toObject$1=toObject$2;var hasOwnProperty=uncurryThis$c({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
var hasOwnProperty_1=Object.hasOwn||function hasOwn(it,key){return hasOwnProperty(toObject$1(it),key);};var uncurryThis$b=functionUncurryThis;var id=0;var postfix=Math.random();var toString$5=uncurryThis$b(1.0.toString);var uid$2=function uid$2(key){return'Symbol('+(key===undefined?'':key)+')_'+toString$5(++id+postfix,36);};var global$g=global$s;var shared$3=shared$4.exports;var hasOwn$8=hasOwnProperty_1;var uid$1=uid$2;var NATIVE_SYMBOL=nativeSymbol;var USE_SYMBOL_AS_UID=useSymbolAsUid;var WellKnownSymbolsStore=shared$3('wks');var Symbol$1=global$g.Symbol;var symbolFor=Symbol$1&&Symbol$1['for'];var createWellKnownSymbol=USE_SYMBOL_AS_UID?Symbol$1:Symbol$1&&Symbol$1.withoutSetter||uid$1;var wellKnownSymbol$7=function wellKnownSymbol$7(name){if(!hasOwn$8(WellKnownSymbolsStore,name)||!(NATIVE_SYMBOL||typeof WellKnownSymbolsStore[name]=='string')){var description='Symbol.'+name;if(NATIVE_SYMBOL&&hasOwn$8(Symbol$1,name)){WellKnownSymbolsStore[name]=Symbol$1[name];}else if(USE_SYMBOL_AS_UID&&symbolFor){WellKnownSymbolsStore[name]=symbolFor(description);}else{WellKnownSymbolsStore[name]=createWellKnownSymbol(description);}}return WellKnownSymbolsStore[name];};var global$f=global$s;var call$4=functionCall;var isObject$4=isObject$6;var isSymbol$2=isSymbol$3;var getMethod$1=getMethod$2;var ordinaryToPrimitive=ordinaryToPrimitive$1;var wellKnownSymbol$6=wellKnownSymbol$7;var TypeError$5=global$f.TypeError;var TO_PRIMITIVE=wellKnownSymbol$6('toPrimitive');// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
var toPrimitive$1=function toPrimitive$1(input,pref){if(!isObject$4(input)||isSymbol$2(input))return input;var exoticToPrim=getMethod$1(input,TO_PRIMITIVE);var result;if(exoticToPrim){if(pref===undefined)pref='default';result=call$4(exoticToPrim,input,pref);if(!isObject$4(result)||isSymbol$2(result))return result;throw TypeError$5("Can't convert object to primitive value");}if(pref===undefined)pref='number';return ordinaryToPrimitive(input,pref);};var toPrimitive=toPrimitive$1;var isSymbol$1=isSymbol$3;// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
var toPropertyKey$2=function toPropertyKey$2(argument){var key=toPrimitive(argument,'string');return isSymbol$1(key)?key:key+'';};var global$e=global$s;var isObject$3=isObject$6;var document$2=global$e.document;// typeof document.createElement is 'object' in old IE
var EXISTS$1=isObject$3(document$2)&&isObject$3(document$2.createElement);var documentCreateElement$1=function documentCreateElement$1(it){return EXISTS$1?document$2.createElement(it):{};};var DESCRIPTORS$6=descriptors;var fails$9=fails$e;var createElement=documentCreateElement$1;// Thanks to IE8 for its funny defineProperty
...
if(!isCallable$6(store$1.inspectSource)){store$1.inspectSource=function(it){return functionToString$1(it);};}var inspectSource$3=store$1.inspectSource;var global$b=global$s;var isCallable$5=isCallable$c;var inspectSource$2=inspectSource$3;var WeakMap$2=global$b.WeakMap;var nativeWeakMap=isCallable$5(WeakMap$2)&&/native code/.test(inspectSource$2(WeakMap$2));var shared$2=shared$4.exports;var uid=uid$2;var keys=shared$2('keys');var sharedKey$2=function sharedKey$2(key){return keys[key]||(keys[key]=uid(key));};var hiddenKeys$4={};var NATIVE_WEAK_MAP=nativeWeakMap;var global$a=global$s;var uncurryThis$9=functionUncurryThis;var isObject$1=isObject$6;var createNonEnumerableProperty$3=createNonEnumerableProperty$4;var hasOwn$6=hasOwnProperty_1;var shared$1=sharedStore;var sharedKey$1=sharedKey$2;var hiddenKeys$3=hiddenKeys$4;var OBJECT_ALREADY_INITIALIZED='Object already initialized';var TypeError$2=global$a.TypeError;var WeakMap$1=global$a.WeakMap;var set,get,has$4;var enforce=function enforce(it){return has$4(it)?get(it):set(it,{});};var getterFor=function getterFor(TYPE){return function(it){var state;if(!isObject$1(it)||(state=get(it)).type!==TYPE){throw TypeError$2('Incompatible receiver, '+TYPE+' required');}return state;};};if(NATIVE_WEAK_MAP||shared$1.state){var store=shared$1.state||(shared$1.state=new WeakMap$1());var wmget=uncurryThis$9(store.get);var wmhas=uncurryThis$9(store.has);var wmset=uncurryThis$9(store.set);set=function set(it,metadata){if(wmhas(store,it))throw new TypeError$2(OBJECT_ALREADY_INITIALIZED);metadata.facade=it;wmset(store,it,metadata);return metadata;};get=function get(it){return wmget(store,it)||{};};has$4=function has$4(it){return wmhas(store,it);};}else{var STATE=sharedKey$1('state');hiddenKeys$3[STATE]=true;set=function set(it,metadata){if(hasOwn$6(it,STATE))throw new TypeError$2(OBJECT_ALREADY_INITIALIZED);metadata.facade=it;createNonEnumerableProperty$3(it,STATE,metadata);return metadata;};get=function get(it){return hasOwn$6(it,STATE)?it[STATE]:{};};has$4=function has$4(it){return hasOwn$6(it,STATE);};}var internalState={set:set,get:get,has:has$4,enforce:enforce,getterFor:getterFor};var DESCRIPTORS$1=descriptors;var hasOwn$5=hasOwnProperty_1;var FunctionPrototype=Function.prototype;// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
...
var toIntegerOrInfinity$3=function toIntegerOrInfinity$3(argument){var number=+argument;// eslint-disable-next-line no-self-compare -- safe
...
var toAbsoluteIndex$1=function toAbsoluteIndex$1(index,length){var integer=toIntegerOrInfinity$2(index);return integer<0?max(integer+length,0):min$1(integer,length);};var toIntegerOrInfinity$1=toIntegerOrInfinity$3;var min=Math.min;// `ToLength` abstract operation
// https://tc39.es/ecma262/#sec-tolength
var toLength$2=function toLength$2(argument){return argument>0?min(toIntegerOrInfinity$1(argument),0x1FFFFFFFFFFFFF):0;// 2 ** 53 - 1 == 9007199254740991
};var toLength$1=toLength$2;// `LengthOfArrayLike` abstract operation
// https://tc39.es/ecma262/#sec-lengthofarraylike
var lengthOfArrayLike$2=function lengthOfArrayLike$2(obj){return toLength$1(obj.length);};var toIndexedObject$3=toIndexedObject$5;var toAbsoluteIndex=toAbsoluteIndex$1;var lengthOfArrayLike$1=lengthOfArrayLike$2;// `Array.prototype.{ indexOf, includes }` methods implementation
var createMethod$2=function createMethod$2(IS_INCLUDES){return function($this,el,fromIndex){var O=toIndexedObject$3($this);var length=lengthOfArrayLike$1(O);var index=toAbsoluteIndex(fromIndex,length);var value;// Array#includes uses SameValueZero equality algorithm
...
indexOf:createMethod$2(false)};var uncurryThis$8=functionUncurryThis;var hasOwn$3=hasOwnProperty_1;var toIndexedObject$2=toIndexedObject$5;var indexOf$2=arrayIncludes.indexOf;var hiddenKeys$2=hiddenKeys$4;var push$2=uncurryThis$8([].push);var objectKeysInternal=function objectKeysInternal(object,names){var O=toIndexedObject$2(object);var i=0;var result=[];var key;for(key in O){!hasOwn$3(hiddenKeys$2,key)&&hasOwn$3(O,key)&&push$2(result,key);}// Don't enum bug & hidden keys
...
:(result=classofRaw(O))=='Object'&&isCallable$2(O.callee)?'Arguments':result;};var global$6=global$s;var classof$4=classof$5;var String$1=global$6.String;var toString$4=function toString$4(argument){if(classof$4(argument)==='Symbol')throw TypeError('Cannot convert a Symbol value to a string');return String$1(argument);};var anObject$4=anObject$7;// `RegExp.prototype.flags` getter implementation
// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
var regexpFlags$1=function regexpFlags$1(){var that=anObject$4(this);var result='';if(that.global)result+='g';if(that.ignoreCase)result+='i';if(that.multiline)result+='m';if(that.dotAll)result+='s';if(that.unicode)result+='u';if(that.sticky)result+='y';return result;};var fails$6=fails$e;var global$5=global$s;// babel-minify and Closure Compiler transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
...
result[IE_PROTO]=O;}else result=_NullProtoObject();return Properties===undefined?result:definePropertiesModule.f(result,Properties);};var fails$5=fails$e;var global$4=global$s;// babel-minify and Closure Compiler transpiles RegExp('.', 's') -> /./s and it causes SyntaxError
...
$$5({target:'RegExp',proto:true,forced:/./.exec!==exec$1},{exec:exec$1});var uncurryThis$5=functionUncurryThis;var redefine$1=redefine$3.exports;var regexpExec$1=regexpExec$2;var fails$3=fails$e;var wellKnownSymbol$3=wellKnownSymbol$7;var createNonEnumerableProperty=createNonEnumerableProperty$4;var SPECIES$2=wellKnownSymbol$3('species');var RegExpPrototype=RegExp.prototype;var fixRegexpWellKnownSymbolLogic=function fixRegexpWellKnownSymbolLogic(KEY,exec,FORCED,SHAM){var SYMBOL=wellKnownSymbol$3(KEY);var DELEGATES_TO_SYMBOL=!fails$3(function(){// String methods call symbol-named RegEp methods
...
var advanceStringIndex$1=function advanceStringIndex$1(S,index,unicode){return index+(unicode?charAt(S,index).length:1);};var global$2=global$s;var call$1=functionCall;var anObject$1=anObject$7;var isCallable$1=isCallable$c;var classof$3=classofRaw$1;var regexpExec=regexpExec$2;var TypeError$1=global$2.TypeError;// `RegExpExec` abstract operation
// https://tc39.es/ecma262/#sec-regexpexec
var regexpExecAbstract=function regexpExecAbstract(R,S){var exec=R.exec;if(isCallable$1(exec)){var result=call$1(exec,R,S);if(result!==null)anObject$1(result);return result;}if(classof$3(R)==='RegExp')return call$1(regexpExec,R,S);throw TypeError$1('RegExp#exec called on incompatible receiver');};var call=functionCall;var fixRegExpWellKnownSymbolLogic=fixRegexpWellKnownSymbolLogic;var anObject=anObject$7;var toLength=toLength$2;var toString$1=toString$4;var requireObjectCoercible=requireObjectCoercible$4;var getMethod=getMethod$2;var advanceStringIndex=advanceStringIndex$1;var regExpExec=regexpExecAbstract;// @@match logic
...
var addToUnscopables$2=function addToUnscopables$2(key){ArrayPrototype[UNSCOPABLES][key]=true;};var $$4=_export;var $includes=arrayIncludes.includes;var addToUnscopables$1=addToUnscopables$2;// `Array.prototype.includes` method
// https://tc39.es/ecma262/#sec-array.prototype.includes
...
addToUnscopables$1('includes');var fails$2=fails$e;var arrayMethodIsStrict$1=function arrayMethodIsStrict$1(METHOD_NAME,argument){var method=[][METHOD_NAME];return!!method&&fails$2(function(){// eslint-disable-next-line no-useless-call -- required for testing
...
var functionBindContext=function functionBindContext(fn,that){aCallable(fn);return that===undefined?fn:NATIVE_BIND?bind$3(fn,that):function/* ...args */(){return fn.apply(that,arguments);};};var classof$2=classofRaw$1;// `IsArray` abstract operation
// https://tc39.es/ecma262/#sec-isarray
// eslint-disable-next-line es/no-array-isarray -- safe
var isArray$5=Array.isArray||function isArray(argument){return classof$2(argument)=='Array';};var uncurryThis$1=functionUncurryThis;var fails$1=fails$e;var isCallable=isCallable$c;var classof$1=classof$5;var getBuiltIn=getBuiltIn$5;var inspectSource=inspectSource$3;var noop=function noop(){/* empty */};var empty=[];var construct=getBuiltIn('Reflect','construct');var constructorRegExp=/^\s*(?:class|function)\b/;var exec=uncurryThis$1(constructorRegExp.exec);var INCORRECT_TO_STRING=!constructorRegExp.exec(noop);var isConstructorModern=function isConstructor(argument){if(!isCallable(argument))return false;try{construct(noop,empty,argument);return true;}catch(error){return false;}};var isConstructorLegacy=function isConstructor(argument){if(!isCallable(argument))return false;switch(classof$1(argument)){case'AsyncFunction':case'GeneratorFunction':case'AsyncGeneratorFunction':return false;}try{// we can't check .prototype since constructors produced by .bind haven't it
...
var arraySpeciesConstructor$1=function arraySpeciesConstructor$1(originalArray){var C;if(isArray$4(originalArray)){C=originalArray.constructor;// cross-realm fallback
...
e.clipboardData.clearData();e.clipboardData.setData(options.format,text);}}if(options.onCopy){e.preventDefault();options.onCopy(e.clipboardData);}});document.body.appendChild(mark);range.selectNodeContents(mark);selection.addRange(range);var successful=document.execCommand("copy");if(!successful){throw new Error("copy command was unsuccessful");}success=true;}catch(err){debug&&console.error("unable to copy using execCommand: ",err);debug&&console.warn("trying IE specific stuff");try{window.clipboardData.setData(options.format||"text",text);options.onCopy&&options.onCopy(window.clipboardData);success=true;}catch(err){debug&&console.error("unable to copy using clipboardData: ",err);debug&&console.error("falling back to prompt");message=format("message"in options?options.message:defaultMessage);window.prompt(message,text);}}finally{if(selection){if(typeof selection.removeRange=="function"){selection.removeRange(range);}else{selection.removeAllRanges();}}if(mark){document.body.removeChild(mark);}reselectPrevious();}return success;}var copyToClipboard=copy;var PREVIEW_URL$2=window_1.PREVIEW_URL;var copyMapper=function copyMapper(_ref153){var state=_ref153.state;var storyId=state.storyId,refId=state.refId,refs=state.refs;var ref=refs[refId];return{refId:refId,baseUrl:ref?"".concat(ref.url,"/iframe.html"):PREVIEW_URL$2||'iframe.html',storyId:storyId,queryParams:state.customQueryParams};};var copyTool={title:'copy',id:'copy',match:function match(_ref154){var viewMode=_ref154.viewMode;return viewMode==='story';},render:function render(){return React$2.createElement(Consumer,{filter:copyMapper},function(_ref155){var baseUrl=_ref155.baseUrl,storyId=_ref155.storyId,queryParams=_ref155.queryParams;return storyId?React$2.createElement(IconButton,{key:"copy",onClick:function onClick(){return copyToClipboard(getStoryHref(baseUrl,storyId,queryParams));},title:"Copy canvas link"},React$2.createElement(Icons,{icon:"link"})):null;});}};var PREVIEW_URL$1=window_1.PREVIEW_URL;var ejectMapper=function ejectMapper(_ref156){var state=_ref156.state;var storyId=state.storyId,refId=state.refId,refs=state.refs;var ref=refs[refId];return{refId:refId,baseUrl:ref?"".concat(ref.url,"/iframe.html"):PREVIEW_URL$1||'iframe.html',storyId:storyId,queryParams:state.customQueryParams};};var ejectTool={title:'eject',id:'eject',match:function match(_ref157){var viewMode=_ref157.viewMode;return viewMode==='story';},render:function render(){return React$2.createElement(Consumer,{filter:ejectMapper},function(_ref158){var baseUrl=_ref158.baseUrl,storyId=_ref158.storyId,queryParams=_ref158.queryParams;return storyId?React$2.createElement(IconButton,{key:"opener",href:getStoryHref(baseUrl,storyId,queryParams),target:"_blank",title:"Open canvas in new tab"},React$2.createElement(Icons,{icon:"sharealt"})):null;});}};var menuMapper$1=function menuMapper$1(_ref159){var api=_ref159.api,state=_ref159.state;return{isVisible:state.layout.showNav,singleStory:state.singleStory,toggle:function toggle(){return api.toggleNav();}};};var menuTool={title:'menu',id:'menu',match:function match(_ref160){var viewMode=_ref160.viewMode;return viewMode==='story';},render:function render(){return React$2.createElement(Consumer,{filter:menuMapper$1},function(_ref161){var isVisible=_ref161.isVisible,toggle=_ref161.toggle,singleStory=_ref161.singleStory;return!singleStory&&!isVisible&&React$2.createElement(React$2.Fragment,null,React$2.createElement(IconButton,{"aria-label":"Show sidebar",key:"menu",onClick:toggle,title:"Show sidebar"},React$2.createElement(Icons,{icon:"menu"})),React$2.createElement(Separator,null));});}};var menuMapper=function menuMapper(_ref162){var api=_ref162.api,state=_ref162.state;return{isVisible:state.layout.showPanel,singleStory:state.singleStory,panelPosition:state.layout.panelPosition,toggle:function toggle(){return api.togglePanel();}};};var addonsTool={title:'addons',id:'addons',match:function match(_ref163){var viewMode=_ref163.viewMode;return viewMode==='story';},render:function render(){return React$2.createElement(Consumer,{filter:menuMapper},function(_ref164){var isVisible=_ref164.isVisible,toggle=_ref164.toggle,singleStory=_ref164.singleStory,panelPosition=_ref164.panelPosition;return!singleStory&&!isVisible&&React$2.createElement(React$2.Fragment,null,React$2.createElement(IconButton,{"aria-label":"Show addons",key:"addons",onClick:toggle,title:"Show addons"},React$2.createElement(Icons,{icon:panelPosition==='bottom'?'bottombar':'sidebaralt'})));});}};var TOOLBAR_EXCLUSION_PARAM='toolbarExclude';var getTools=function getTools(getFn){return Object.values(getFn(types.TOOL));};var getToolsExtra=function getToolsExtra(getFn){return Object.values(getFn(types.TOOLEXTRA));};var Bar=function Bar(_a){var props=__rest(_a,["shown"]);return React$2.createElement(FlexBar,Object.assign({},props));};var Toolbar=styled(Bar)({position:'absolute',left:0,right:0,top:0,transition:'transform .2s linear'},function(_ref165){var shown=_ref165.shown;return{transform:shown?'translateY(0px)':'translateY(-40px)'};});var fullScreenMapper=function fullScreenMapper(_ref166){var api=_ref166.api,state=_ref166.state;return{toggle:api.toggleFullscreen,value:state.layout.isFullscreen,shortcut:shortcutToHumanString(api.getShortcutKeys().fullScreen),hasPanel:Object.keys(api.getPanels()).length>0,singleStory:state.singleStory};};var fullScreenTool={title:'fullscreen',id:'fullscreen',match:function match(p){return['story','docs'].includes(p.viewMode);},render:function render(){return React$2.createElement(Consumer,{filter:fullScreenMapper},function(_ref167){var toggle=_ref167.toggle,value=_ref167.value,shortcut=_ref167.shortcut,hasPanel=_ref167.hasPanel,singleStory=_ref167.singleStory;return(!singleStory||singleStory&&hasPanel)&&React$2.createElement(IconButton,{key:"full",onClick:toggle,title:"".concat(value?'Exit full screen':'Go full screen'," [").concat(shortcut,"]")},React$2.createElement(Icons,{icon:value?'close':'expand'}));});}};var tabsMapper=function tabsMapper(_ref168){var state=_ref168.state;return{viewMode:state.docsOnly,storyId:state.storyId,path:state.path,location:state.location,refId:state.refId};};var createTabsTool=function createTabsTool(tabs){return{title:'title',id:'title',render:function render(){return React$2.createElement(Consumer,{filter:tabsMapper},function(rp){return React$2.createElement(Fragment,null,React$2.createElement(TabBar,{key:"tabs"},tabs.filter(function(p){return!p.hidden;}).map(function(t,index){var to=t.route(rp);var isActive=rp.path===to;return React$2.createElement(UnstyledLink,{key:t.id||"l".concat(index),to:to},React$2.createElement(TabButton,{disabled:t.disabled,active:isActive},t.title));})),React$2.createElement(Separator,null));});}};};var defaultTools=[zoomTool];var defaultToolsExtra=[addonsTool,fullScreenTool,ejectTool,copyTool];var useTools=function useTools(getElements,tabs,viewMode,story,location,path,getQueryParam){var toolsFromConfig=useMemo(function(){return getTools(getElements);},[getElements]);var toolsExtraFromConfig=useMemo(function(){return getToolsExtra(getElements);},[getElements]);var tools=useMemo(function(){return[].concat(defaultTools,_toConsumableArray(toolsFromConfig));},[defaultTools,toolsFromConfig]);var toolsExtra=useMemo(function(){return[].concat(defaultToolsExtra,_toConsumableArray(toolsExtraFromConfig));},[defaultToolsExtra,toolsExtraFromConfig]);var toolbarExclusions=getQueryParam&&getQueryParam(TOOLBAR_EXCLUSION_PARAM)?getQueryParam(TOOLBAR_EXCLUSION_PARAM).split(','):[];return useMemo(function(){return story&&story.parameters?filterTools(tools,toolsExtra,tabs,{viewMode:viewMode,story:story,location:location,path:path,toolbarExclusions:toolbarExclusions}):{left:tools,right:toolsExtra};},[viewMode,story,location,path,tools,toolsExtra,tabs]);};var ToolRes=React$2.memo(function(_ref169){var api=_ref169.api,story=_ref169.story,tabs=_ref169.tabs,isShown=_ref169.isShown,location=_ref169.location,path=_ref169.path,viewMode=_ref169.viewMode;var _useTools=useTools(api.getElements,tabs,viewMode,story,location,path,api.getQueryParam),left=_useTools.left,right=_useTools.right;return left||right?React$2.createElement(Toolbar,{key:"toolbar",shown:isShown,border:true},React$2.createElement(Tools,{key:"left",list:left}),React$2.createElement(Tools,{key:"right",list:right})):null;});var ToolbarComp=React$2.memo(function(props){return React$2.createElement(Location,null,function(_ref170){var location=_ref170.location,path=_ref170.path,viewMode=_ref170.viewMode;return React$2.createElement(ToolRes,Object.assign({},props,{location:location,path:path,viewMode:viewMode}));});});var Tools=React$2.memo(function(_ref171){var list=_ref171.list;return React$2.createElement(React$2.Fragment,null,list.filter(Boolean).map(function(_a,index){var Render=_a.render,id=_a.id,t=__rest(_a,["render","id"]);return(// @ts-ignore
React$2.createElement(Render,{key:id||t.key||"f-".concat(index)}));}));});function toolbarItemHasBeenExcluded(item,story){var _a;var toolbarItemsFromStoryParameters='toolbar'in story.parameters?story.parameters.toolbar:undefined;var _addons$getConfig=addons.getConfig(),toolbarItemsFromAddonsConfig=_addons$getConfig.toolbar;var toolbarItems=merge$1(toolbarItemsFromAddonsConfig,toolbarItemsFromStoryParameters);return toolbarItems?!!((_a=toolbarItems[item.id])===null||_a===void 0?void 0:_a.hidden):false;}function filterTools(tools,toolsExtra,tabs,_ref172){var viewMode=_ref172.viewMode,story=_ref172.story,location=_ref172.location,path=_ref172.path,toolbarExclusions=_ref172.toolbarExclusions;var isToolIncluded=function isToolIncluded(id){return toolbarExclusions.filter(function(exclusionKey){return id.match(new RegExp("^".concat(exclusionKey,".*")));}).length===0;};var filteredTabs=tabs.filter(function(tab){return isToolIncluded(tab.id);});var toolsLeft=[menuTool,filteredTabs.filter(function(p){return!p.hidden;}).length>=1&&createTabsTool(filteredTabs)].concat(_toConsumableArray(tools));var toolsRight=_toConsumableArray(toolsExtra);var filter=function filter(item){return item&&(!item.match||item.match({storyId:story.id,refId:story.refId,viewMode:viewMode,location:location,path:path}))&&!toolbarItemHasBeenExcluded(item,story)&&isToolIncluded(item.id);};var left=toolsLeft.filter(filter);var right=toolsRight.filter(filter);return{left:left,right:right};}var StyledIframe=styled.iframe({position:'absolute',display:'block',boxSizing:'content-box',height:'100%',width:'100%',border:'0 none',transition:'all .3s, background-position 0s, visibility 0s',backgroundPosition:'-1px -1px, -1px -1px, -1px -1px, -1px -1px'});function IFrame(props){var active=props.active,id=props.id,title=props.title,src=props.src,allowFullScreen=props.allowFullScreen,scale=props.scale,rest=__rest(props,["active","id","title","src","allowFullScreen","scale"]);var iFrameRef=React$2.useRef(null);return React$2.createElement(Zoom$1.IFrame,{scale:scale,active:active,iFrameRef:iFrameRef},React$2.createElement(StyledIframe,Object.assign({"data-is-storybook":active?'true':'false',onLoad:function onLoad(e){return e.currentTarget.setAttribute('data-is-loaded','true');},id:id,title:title,src:src,allowFullScreen:allowFullScreen,ref:iFrameRef},rest)));}/* eslint complexity: [2, 18], max-statements: [2, 33] */var shams=function hasSymbols(){if(typeof Symbol!=='function'||typeof Object.getOwnPropertySymbols!=='function'){return false;}if(_typeof2(Symbol.iterator)==='symbol'){return true;}var obj={};var sym=Symbol('test');var symObj=Object(sym);if(typeof sym==='string'){return false;}if(Object.prototype.toString.call(sym)!=='[object Symbol]'){return false;}if(Object.prototype.toString.call(symObj)!=='[object Symbol]'){return false;}// temp disabled per https://github.com/ljharb/object.assign/issues/17
...
return listHas($o,key);}}return false;},set:function set(key,value){if($WeakMap&&key&&(_typeof2(key)==='object'||typeof key==='function')){if(!$wm){$wm=new $WeakMap();}$weakMapSet($wm,key,value);}else if($Map){if(!$m){$m=new $Map();}$mapSet($m,key,value);}else{if(!$o){/*
           ...
           */$o={key:{},next:null};}listSet($o,key,value);}}};return channel;};var replace=String.prototype.replace;var percentTwenties=/%20/g;var Format={RFC1738:'RFC1738',RFC3986:'RFC3986'};var formats$3={'default':Format.RFC3986,formatters:{RFC1738:function RFC1738(value){return replace.call(value,percentTwenties,'+');},RFC3986:function RFC3986(value){return String(value);}},RFC1738:Format.RFC1738,RFC3986:Format.RFC3986};var formats$2=formats$3;var has$2=Object.prototype.hasOwnProperty;var isArray$2=Array.isArray;var hexTable=function(){var array=[];for(var i=0;i<256;++i){array.push('%'+((i<16?'0':'')+i.toString(16)).toUpperCase());}return array;}();var compactQueue=function compactQueue(queue){while(queue.length>1){var item=queue.pop();var obj=item.obj[item.prop];if(isArray$2(obj)){var compacted=[];for(var j=0;j<obj.length;++j){if(typeof obj[j]!=='undefined'){compacted.push(obj[j]);}}item.obj[item.prop]=compacted;}}};var arrayToObject=function arrayToObject(source,options){var obj=options&&options.plainObjects?Object.create(null):{};for(var i=0;i<source.length;++i){if(typeof source[i]!=='undefined'){obj[i]=source[i];}}return obj;};var merge=function merge(target,source,options){/* eslint no-param-reassign: 0 */if(!source){return target;}if(_typeof2(source)!=='object'){if(isArray$2(target)){target.push(source);}else if(target&&_typeof2(target)==='object'){if(options&&(options.plainObjects||options.allowPrototypes)||!has$2.call(Object.prototype,source)){target[source]=true;}}else{return[target,source];}return target;}if(!target||_typeof2(target)!=='object'){return[target].concat(source);}var mergeTarget=target;if(isArray$2(target)&&!isArray$2(source)){mergeTarget=arrayToObject(target,options);}if(isArray$2(target)&&isArray$2(source)){source.forEach(function(item,i){if(has$2.call(target,i)){var targetItem=target[i];if(targetItem&&_typeof2(targetItem)==='object'&&item&&_typeof2(item)==='object'){target[i]=merge(targetItem,item,options);}else{target.push(item);}}else{target[i]=item;}});return target;}return Object.keys(source).reduce(function(acc,key){var value=source[key];if(has$2.call(acc,key)){acc[key]=merge(acc[key],value,options);}else{acc[key]=value;}return acc;},mergeTarget);};var assign=function assignSingleSource(target,source){return Object.keys(source).reduce(function(acc,key){acc[key]=source[key];return acc;},target);};var decode=function decode(str,decoder,charset){var strWithoutPlus=str.replace(/\+/g,' ');if(charset==='iso-8859-1'){// unescape never throws, no try...catch needed:
...
var keys=Object.keys(tempObj);for(var i=0;i<keys.length;++i){var key=keys[i];var newObj=parseKeys(key,tempObj[key],options,typeof str==='string');obj=utils.merge(obj,newObj,options);}if(options.allowSparse===true){return obj;}return utils.compact(obj);};var stringify=stringify_1;var parse=parse$1;var formats=formats$3;var lib={formats:formats,parse:parse,stringify:stringify};var stringifyQueryParams=function stringifyQueryParams(queryParams){return lib.stringify(queryParams,{addQueryPrefix:true,encode:false}).replace(/^\?/,'&');};var getActive=function getActive(refId){if(refId){return"storybook-ref-".concat(refId);}return'storybook-preview-iframe';};var SkipToSidebarLink=styled(Button$1)(function(_ref173){var theme=_ref173.theme;return{display:'none','@media (min-width: 600px)':{position:'absolute',top:10,right:15,padding:'10px 15px',fontSize:theme.typography.size.s1,transform:'translateY(-100px)','&:focus':{transform:'translateY(0)',zIndex:1}}};});var whenSidebarIsVisible=function whenSidebarIsVisible(_ref174){var state=_ref174.state;return{isFullscreen:state.layout.isFullscreen,showNav:state.layout.showNav,selectedStoryId:state.storyId};};var FramesRenderer=function FramesRenderer(_ref175){var refs=_ref175.refs,story=_ref175.story,scale=_ref175.scale,_ref175$viewMode=_ref175.viewMode,viewMode=_ref175$viewMode===void 0?'story':_ref175$viewMode,refId=_ref175.refId,_ref175$queryParams=_ref175.queryParams,queryParams=_ref175$queryParams===void 0?{}:_ref175$queryParams,baseUrl=_ref175.baseUrl,_ref175$storyId=_ref175.storyId,storyId=_ref175$storyId===void 0?'*':_ref175$storyId;var _a;var version=(_a=refs[refId])===null||_a===void 0?void 0:_a.version;var stringifiedQueryParams=stringifyQueryParams(Object.assign(Object.assign({},queryParams),version&&{version:version}));var active=getActive(refId);var styles=useMemo(function(){// add #root to make the selector high enough in specificity
return{'#root [data-is-storybook="false"]':{display:'none'},'#root [data-is-storybook="true"]':{display:'block'}};},[]);var _useState11=useState({'storybook-preview-iframe':getStoryHref(baseUrl,storyId,Object.assign(Object.assign(Object.assign({},queryParams),version&&{version:version}),{viewMode:viewMode}))}),_useState12=_slicedToArray2(_useState11,2),frames=_useState12[0],setFrames=_useState12[1];useEffect(function(){var newFrames=Object.values(refs).filter(function(r){if(r.error){return false;}if(r.type==='auto-inject'){return true;}if(story&&r.id===story.refId){return true;}return false;}).reduce(function(acc,r){return Object.assign(Object.assign({},acc),_defineProperty2({},"storybook-ref-".concat(r.id),"".concat(r.url,"/iframe.html?id=").concat(storyId,"&viewMode=").concat(viewMode,"&refId=").concat(r.id).concat(stringifiedQueryParams)));},frames);setFrames(newFrames);},[storyId,story,refs]);return React$2.createElement(Fragment,null,React$2.createElement(Global,{styles:styles}),React$2.createElement(Consumer,{filter:whenSidebarIsVisible},function(_ref176){var isFullscreen=_ref176.isFullscreen,showNav=_ref176.showNav,selectedStoryId=_ref176.selectedStoryId;if(!isFullscreen&&!!showNav&&selectedStoryId){return React$2.createElement(SkipToSidebarLink,{secondary:true,isLink:true,tabIndex:0,href:"#".concat(selectedStoryId)},"Skip to sidebar");}return null;}),Object.entries(frames).map(function(_ref177){var _ref178=_slicedToArray2(_ref177,2),id=_ref178[0],src=_ref178[1];return React$2.createElement(Fragment,{key:id},React$2.createElement(IFrame,{active:id===active,key:refs[id]?refs[id].url:id,id:id,title:id,src:src,allowFullScreen:true,scale:scale}));}));};var getWrappers=function getWrappers(getFn){return Object.values(getFn(types.PREVIEW));};var getTabs=function getTabs(getFn){return Object.values(getFn(types.TAB));};var canvasMapper=function canvasMapper(_ref179){var state=_ref179.state,api=_ref179.api;return{storyId:state.storyId,refId:state.refId,viewMode:state.viewMode,customCanvas:api.renderPreview,queryParams:state.customQueryParams,getElements:api.getElements,story:api.getData(state.storyId,state.refId),storiesConfigured:state.storiesConfigured,storiesFailed:state.storiesFailed,refs:state.refs,active:!!(state.viewMode&&state.viewMode.match(/^(story|docs)$/))};};var createCanvas=function createCanvas(id){var baseUrl=arguments.length>1&&arguments[1]!==undefined?arguments[1]:'iframe.html';var withLoader=arguments.length>2&&arguments[2]!==undefined?arguments[2]:true;return{id:'canvas',title:'Canvas',route:function route(_ref180){var storyId=_ref180.storyId,refId=_ref180.refId;return refId?"/story/".concat(refId,"_").concat(storyId):"/story/".concat(storyId);},match:function match(_ref181){var viewMode=_ref181.viewMode;return!!(viewMode&&viewMode.match(/^(story|docs)$/));},render:function render(){return React$2.createElement(Consumer,{filter:canvasMapper},function(_ref182){var story=_ref182.story,refs=_ref182.refs,customCanvas=_ref182.customCanvas,storyId=_ref182.storyId,refId=_ref182.refId,viewMode=_ref182.viewMode,queryParams=_ref182.queryParams,getElements=_ref182.getElements,storiesConfigured=_ref182.storiesConfigured,storiesFailed=_ref182.storiesFailed,active=_ref182.active;var wrappers=useMemo(function(){return[].concat(defaultWrappers,_toConsumableArray(getWrappers(getElements)));},[getElements].concat(defaultWrappers));var isLoading=story?!!refs[refId]&&!refs[refId].ready:!storiesFailed&&!storiesConfigured;return React$2.createElement(ZoomConsumer,null,function(_ref183){var scale=_ref183.value;return React$2.createElement(React$2.Fragment,null,withLoader&&isLoading&&React$2.createElement(LoaderWrapper$1,null,React$2.createElement(Loader$1,{id:"preview-loader",role:"progressbar"})),React$2.createElement(ApplyWrappers,{id:id,storyId:storyId,viewMode:viewMode,active:active,wrappers:wrappers},customCanvas?customCanvas(storyId,viewMode,id,baseUrl,scale,queryParams):React$2.createElement(FramesRenderer,{baseUrl:baseUrl,refs:refs,scale:scale,story:story,viewMode:viewMode,refId:refId,queryParams:queryParams,storyId:storyId})));});});}};};var useTabs=function useTabs(id,baseUrl,withLoader,getElements,story){var canvas=useMemo(function(){return createCanvas(id,baseUrl,withLoader);},[id,baseUrl,withLoader]);var tabsFromConfig=useMemo(function(){return getTabs(getElements);},[getElements]);return useMemo(function(){if(story===null||story===void 0?void 0:story.parameters){return filterTabs([canvas].concat(_toConsumableArray(tabsFromConfig)),story.parameters);}return[canvas].concat(_toConsumableArray(tabsFromConfig));},[story,canvas].concat(_toConsumableArray(tabsFromConfig)));};var Preview=React$2.memo(function(props){var api=props.api,previewId=props.id,options=props.options,viewMode=props.viewMode,storyId=props.storyId,_props$story=props.story,story=_props$story===void 0?undefined:_props$story,description=props.description,baseUrl=props.baseUrl,_props$withLoader=props.withLoader,withLoader=_props$withLoader===void 0?true:_props$withLoader;var getElements=api.getElements;var tabs=useTabs(previewId,baseUrl,withLoader,getElements,story);var shouldScale=viewMode==='story';var isToolshown=options.isToolshown;var previousStoryId=useRef(storyId);var previousViewMode=useRef(viewMode);useEffect(function(){if(story&&viewMode){// Don't emit the event on first ("real") render, only when story or mode changes
if(storyId!==previousStoryId.current||viewMode!==previousViewMode.current){previousStoryId.current=storyId;previousViewMode.current=viewMode;if(viewMode.match(/docs|story/)){var refId=story.refId,_id2=story.id;api.emit(SET_CURRENT_STORY,{storyId:_id2,viewMode:viewMode,options:{target:refId?"storybook-ref-".concat(refId):'storybook-preview-iframe'}});}}}},[story,viewMode]);return React$2.createElement(Fragment,null,previewId==='main'&&React$2.createElement(W$1,{key:"description"},React$2.createElement("title",null,description)),React$2.createElement(ZoomProvider,{shouldScale:shouldScale},React$2.createElement(ToolbarComp,{key:"tools",story:story,api:api,isShown:isToolshown,tabs:tabs}),React$2.createElement(FrameWrap,{key:"frame",offset:isToolshown?40:0},tabs.map(function(_a,i){var Render=_a.render,match=_a.match,t=__rest(_a,["render","match"]);// @ts-ignore
